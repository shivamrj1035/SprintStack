            ...
            <ScrollArea className="h-full p-4">
              <div className="max-w-xl mx-auto space-y-3 pt-2">
                {[
                  ...
                  <div
                    key={v.ver}
                    className="p-3 border border-border rounded bg-surface space-y-2"
                  >
              ...
              <ScrollArea className="flex-1 p-4">
                <div className="space-y-4">
                  ...
                  {activeCell && (
                    <>
                      <div className="space-y-1.5">
                        <Label htmlFor="m-cell-label" className="text-[11px] text-muted-foreground">
                          Cell Header Label
                        </Label>
                        <Input
                          id="m-cell-label"
                          ...
                          onChange={(e) => {
                            ...
                            setFooterCells((prev) =>
                              prev.map((c) => (c.id === activeCell.id ? { ...c, label: v } : c)),
                            );
                          }}
                          className="h-8 text-xs"
                        />
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="m-cell-name" className="text-[11px] text-muted-foreground">
                          Signee Name Placeholder
                        </Label>
                        <Input
                          id="m-cell-name"
                          ...
                          onChange={(e) => {
                            const v = e.target.value;
                            setFooterCells((prev) =>
                              prev.map((c) => (c.id === activeCell.id ? { ...c, name: v } : c)),
                            );
                          }}
                          className="h-8 text-xs"
                        />
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="m-cell-date" className="text-[11px] text-muted-foreground">
                          Signature Date Placeholder
                        </Label>
                        <Input
                          id="m-cell-date"
                          ...
                          onChange={(e) => {
                            const v = e.target.value;
                            setFooterCells((prev) =>
                              prev.map((c) => (c.id === activeCell.id ? { ...c, date: v } : c)),
                            );
                          }}
                          className="h-8 text-xs"
                        />
            ...
            <div className="flex flex-col h-full">
              ...
              <ScrollArea className="flex-1 p-4">
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5 pt-2">
                    <Label htmlFor="m-field-label" className="text-[11px] text-muted-foreground">
                      Field Label
                    </Label>
                    <Input
                      id="m-field-label"
