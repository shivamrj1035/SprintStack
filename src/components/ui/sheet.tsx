...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/80 backdrop-blur-2xl p-6 shadow-2xl transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
