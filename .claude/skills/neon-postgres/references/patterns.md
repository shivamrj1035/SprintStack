...
Using pooled connection for migrations ###### **Why**
DDL operations fail through PgBouncer ###### **Fix**
...
Not using connection pooling ###### **Why**
Serverless functions exhaust connection limits ###### **Fix**
...
Using pg driver in serverless ###### **Why**
TCP connections don't work in all edge environments ###### **Fix**
...
HTTP driver for transactions ###### **Why**
HTTP driver doesn't support transactions ###### **Fix**
...
Opening new connection per request ###### **Why**
Exhausts connection limits quickly ###### **Fix**
...
High max pool size in serverless ###### **Why**
Many function instances = many pools = many connections ###### **Fix**
...
Sharing production database for development ###### **Why**
Risk of data corruption, no isolation ###### **Fix**
...
Not cleaning up old branches ###### **Why**
Accumulates storage and clutter ###### **Fix**
...
Same database for all previews ###### **Why**
Previews interfere with each other ###### **Fix**
...
Not running migrations on preview ###### **Why**
Schema mismatch between code and database ###### **Fix**
...
Scale-to-zero in production ###### **Why**
Cold starts add 500ms+ latency to first request ###### **Fix**
...
No retry logic for cold starts ###### **Why**
First connection after idle may timeout ###### **Fix**
